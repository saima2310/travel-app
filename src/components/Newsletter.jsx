            ...
            <div className='p-5 bg-white/60 ring-1 ring-emerald-200 shadow-md shadow-emerald-300 rounded-lg max-w-5xl w-full ml-auto mr-auto mt-0 xl:w-[95vw] relative top-12'>
                ...
                <div className='flex items-center justify-between lg:flex-col lg:gap-7'>
                    ...
                    <div className='grid items-center sm:text-center'>
                        ...
                        <p className='text-base sm:text-sm xsm:text-xs font-medium'>Questions and Feedbacks? We Would Love To Hear From You</p>
                    </div>
                    ...
                    <form className='flex items-center justify-center relative'>
                        ...
                        />
                        <button className='text-base px-5 py-2 text-white bg-gradient-to-b from-emerald-500 to-green-500 rounded-r-full transition-all duration-200 active:scale-90 absolute right-0 shadow-lg shadow-emerald-400' type='button'>
                            Submit
                        </button>
                    </form>
                </div>
